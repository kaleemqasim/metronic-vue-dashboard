  ...
  <div :class="widgetClasses" class="card">
    ...
    <div class="card-header border-0 py-5">
      <h3 class="card-title align-items-start flex-column">
        <span class="card-label fw-bolder fs-3 mb-1">User Base</span>
        <span class="text-muted fw-bold fs-7">37% are Affiliates</span>
      </h3>
    ...
    <div class="card-body d-flex flex-column">
      ...
      <div class="pt-5">
        ...
        <a href="#" class="btn w-100 py-3 btn-danger"
          >Increase Users</a
        >
      </div>
    </div>
