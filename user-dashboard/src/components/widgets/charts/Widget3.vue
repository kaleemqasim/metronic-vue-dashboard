  ...
  <div :class="widgetClasses" class="card">
    ...
    <div class="card-header border-0 pt-5">
      <h3 class="card-title align-items-start flex-column">
        <span class="card-label fw-bolder fs-3 mb-1">Average Industry Performance</span>

        <span class="text-muted fw-bold fs-7">Based on similar industry revenue category</span>
      </h3>
