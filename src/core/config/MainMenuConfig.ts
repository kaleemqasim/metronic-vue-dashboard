        ...
        sub: [
          {
            ...
            route: "/product-management/ProductListing",
          },
          {
            heading: "Promotion Management",
            route: "/product-management/PromotionManagement",
          },
          {
            heading: "Coupon Management",
            route: "/product-management/CouponManagement",
          },
        ],
      },
    ],
        ...
        sub: [
          {
            ...
            route: "/income-statement/SalesTransaction",
          },
          {
            heading: "Payment Receipting",
            route: "/income-statement/PaymentReceipting",
          },
        ],
      },
    ],
        ...
        sub: [
          {
            ...
            route: "/product-analytics/ProductAnalytics",
          },
          {
            heading: "Product Report",
            route: "/product-analytics/ProductReport",
          },
        ],
      },
    ],
        ...
        sub: [
          {
            ...
            route: "/customer-analytics/CustomerAnalytics",
          },
          {
            heading: "Customer Report",
            route: "/customer-analytics/CustomerReport",
          },
        ],
      },
    ],
...
const DocMenuConfigUser = [
  ...
  {
    route: "/user/information-search",
    pages: [
      {
        sectionTitle: "Information Search",
        route: "/user/information-search",
        svgIcon: "media/icons/duotune/general/gen022.svg",
        fontIcon: "bi-archive",
        sub: [
          {
            heading: "Entity Search",
          ...
          {
            heading: "Link Relationship",
            route: "/user/information-search/LinkRelationship",
          },
        ],
      },
    ],
  ...
  },
  {
    pages: [
      {
        heading: "My Statement",
        route: "/user/my-statement",
        svgIcon: "media/icons/duotune/general/gen025.svg",
        fontIcon: "bi-app-indicator",
      }
    ],
...
if (userType === 'user') {
  defaultMenuConfig = DocMenuConfigUser;
} else {
  defaultMenuConfig = DocMenuConfig;
}
