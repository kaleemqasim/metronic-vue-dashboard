          ...
          <el-form
            ...
            >
              ...
              <div class="fv-row pe-3 w-125px">
                <!--begin::Input-->
                <el-select  v-model="formData.exportFormat" class="d-block" placeholder="Customer">
              ...
              <div class="fv-row pe-3 w-125px">
                <!--begin::Input-->
                <el-select  v-model="formData.exportFormat" class="d-block" placeholder="Value Range">
                  <el-option value="excel" key="excel" label="Excel" />
                  <el-option value="pdf" key="pdf" label="PDF" />
                  <el-option value="cvs" key="cvs" label="CVS" />
                  <el-option value="zip" key="zip" label="ZIP" />
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const customers = ref<Array<ICustomer>>([
        {
          ...
          name: "Kamrul Hamzah Christopher",
          Product: "Kamrul Hamzah Christopher",
           date: "5 Apr 2023",
           value:"15.00",
      ...
      onMounted(() => {
        ...
        setCurrentPageBreadcrumbs("Customer Report", ["Customer Analytics"]);
      });
