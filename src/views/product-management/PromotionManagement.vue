    ...
    <div class="card">
        <div class="breadCrumb_btn d-flex justify-content-end pt-6 px-9">
            <div
              ...
              >
              <router-link
                  to="/product-management/PromotionUsage"
      ...
      <div class="card-body pt-0">
        ...
        <template v-slot:cell-discount="{ row: customer }">
            <span class="text-success">{{ customer.discount }}</span>
        </template>
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      onMounted(() => {
        ...
        setCurrentPageBreadcrumbs("Promotion Management", ["Product Management"]);
      });
