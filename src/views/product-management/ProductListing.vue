  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const customers = ref<Array<ICustomer>>([
        ...
        {
          id: Math.floor(Math.random() * 99999) + 1,
          name: "Shareholder Listing and Analysis",
          category: "ROC - Company Profile",
          ssmFees: "RM10.00",
          serviceFees: "RM5.00",
          detail:"view",
        ...
        {
          id: Math.floor(Math.random() * 99999) + 1,
          name: "Certificates of Incorporation",
          category: "ROC - Company Profile",
          ssmFees: "RM10.00",
          serviceFees: "RM5.00",
          detail:"view",
        ...
        {
          id: Math.floor(Math.random() * 99999) + 1,
          name: "Certificates of Change of Name",
          category: "ROC - Company Profile",
          ssmFees: "RM10.00",
          serviceFees: "RM5.00",
          detail:"view",
        ...
        {
          id: Math.floor(Math.random() * 99999) + 1,
          name: "Certificates of Conversion",
          category: "ROC - Company Profile",
          ssmFees: "RM10.00",
          serviceFees: "RM5.00",
          detail:"view",
        ...
        {
          id: Math.floor(Math.random() * 99999) + 1,
          name: "Particulars of Directors/Officers",
          category: "ROC - Company Profile",
          ssmFees: "RM10.00",
          serviceFees: "RM5.00",
          detail:"view",
        ...
        {
          id: Math.floor(Math.random() * 99999) + 1,
          name: "Particulars of Registered Address",
          category: "ROC - Company Profile",
          ssmFees: "RM10.00",
          serviceFees: "RM5.00",
          detail:"view",
